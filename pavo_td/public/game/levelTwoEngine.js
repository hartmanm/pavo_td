...
function preload ()
{
  ...
  game.load.spritesheet('boom', 'game/two/explosion_transparent.png', 64, 64, 23);
  game.load.spritesheet('bomb_explode', 'game/two/explosion_transparent.png', 64, 64, 23);
...
function create ()
{
  ...
  logo = game.add.sprite(75, 155, 'logo');
